    ...
    <Animated.View style={[
      ...
      <Animated.View
        style={[{
          ...
          position: "absolute",
          width: (width - 25) / props?.tabs?.length,
          top: 0,
          marginVertical: 2,
          marginHorizontal: 2,
        ...
        props?.tabs.map((tab, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              activeOpacity={0.7} >
              <Text numberOfLines={1} category='p1' style={[styles.textStyles, { color: props?.textColor }, isCurrentIndex && { color: props?.activeTextColor }]}>{tab}</Text>
            </TouchableOpacity>
          )
        })
      }
